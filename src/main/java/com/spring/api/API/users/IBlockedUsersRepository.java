...
import com.spring.api.API.users.BlockedUsers.BlockedUsers;
import com.spring.api.API.users.BlockedUsers.BlockedUsersId;
import com.spring.api.API.users.dtos.UsersBlocked;
...
public interface IBlockedUsersRepository extends JpaRepository<BlockedUsers, BlockedUsersId> {
    ...
    @Query("""
        SELECT new com.spring.api.API.users.dtos.UsersBlocked(
            bu.blocked.id,
            bu.blocked.username,
            bu.blockedDate        
        ) 
